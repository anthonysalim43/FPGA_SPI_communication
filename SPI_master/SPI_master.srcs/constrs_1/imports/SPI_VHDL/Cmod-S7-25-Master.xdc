...
#create_clock -period 83.333 -name sys_clk_pin [get_ports clk]

#create_clock -period 1000.000 -name sys_clk_pin -waveform {0.000 900.000} -add [get_ports clk]
...
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets sclk]
...
set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS33 } [get_ports { mosi_out }]; #IO_L4N_T0_D05_14 Sch=pio[23]
...
#set_property -dict { PACKAGE_PIN L11   IOSTANDARD LVCMOS33 } [get_ports { ss_n }]; #IO_L6P_T0_FCS_B_14 Sch=qspi_cs
#set_property -dict { PACKAGE_PIN H14   IOSTANDARD LVCMOS33 } [get_ports { mosi }]; #IO_L1P_T0_D00_MOSI_14 Sch=qspi_dq[0]
#set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { miso }]; #IO_L1N_T0_D01_DIN_14 Sch=qspi_dq[1]
#set_property -dict { PACKAGE_PIN J12   IOSTANDARD LVCMOS33 } [get_ports {  sclk }]; #IO_L2P_T0_D02_14 Sch=qspi_dq[2]
